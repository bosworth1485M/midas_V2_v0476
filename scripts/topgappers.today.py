...
# - Still calls prev_trading_day_polygon.py to resolve prior trading day
...
def main():
    ...
    ap.add_argument("--top",       type=int,   default=50)  # prints top N; file will also be trimmed now
    ...
    if not args.no_write:
        # Apply --top to the written universe as well (was previously writing all symbols).
