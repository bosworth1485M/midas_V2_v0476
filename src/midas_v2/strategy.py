...
class SimpleBreakoutStrategy:
    ...
    def should_enter(self, bars: List[Bar], i: int) -> bool:
        ...
        # v0.4.8: single-line plug-in hook (sidecar-driven; OFF by default)
        try:  # v0.4.8
            if should_block_entry(getattr(self, "scenario_id", ""), getattr(self, "symbol", ""), bars[i], self):  # v0.4.8
                return False  # v0.4.8
        except Exception:  # v0.4.8
            pass  # fail-open (preserve baseline)  # v0.4.8
