# Smoke Test Suite — Midas_V2 v0.4.4 uopdate for version v0.4.5
## Purpose
...
### 1️⃣ VWAP Slope Gate Test (Scenario E) ## change from B
**Goal:** Ensure VWAP slope filtering is active (VWAP reclaim logic lives only in Scenario E).  
...
python scripts\run_catalyst_flow.py --date 2025-08-05 --scenario E --news-first --require-news --news-min-score 3 --top 3 --enforce-band --band-min 10 --band-max 40 --deny-negative --exclude-china --min-rvol-open 2.0 --gate-minutes 15
```
Expected: `Trades=0`
