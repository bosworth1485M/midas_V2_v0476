...
Apply this spec exactly. Do not modify any files other than `src/midas_v2/engine/backtester.py`. Do not change existing logic outside the described guard.

BEGIN CONTEXT
Previous version: v0.8.1.7.1
...
- Execution correctness hotfix from v0.8.1.7.1 (TP/SL rebase at confirm-time + TP/SL↔PnL invariants) (KEEP)
...
- Touch execution correctness hotfix behavior from v0.8.1.7.1
...
- Execution correctness hotfix behavior from v0.8.1.7.1 remains unchanged
